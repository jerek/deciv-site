...
$files_dir = __DIR__ . "/downloads/episodes/";

// Corresponding url for accessing the above directory. TRAILING SLASH REQ'D.
$files_url = "http://deciv.com/downloads/episodes/";

// Location of getid3 folder, leave blank to disable. TRAILING SLASH REQ'D.
# $getid3_dir = "getid3/";
$getid3_dir = dirname(__DIR__) . "/vendor/getID3-master/getid3/";

// ====================================================== Generic feed options

// Your feed's title
$feed_title = "Decivilization: A Post-Apocalyptic RPG Podcast";

// 'More info' link for your feed
$feed_link = "http://deciv.com/";

// Brief description
$feed_description = "A post-apocalyptic RPG podcast in a world full of warring city-states, raiders, and strange creatures, all fighting to survive.";

// Copyright / license information
$feed_copyright = "All content &#0169; River City Games " . date("Y");
